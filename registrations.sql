...
INSERT INTO `registrations` (`registration_id`, `user_id`, `service_id`, `registration_date`) VALUES
(1, 1, 1, '2025-05-10'),
(2, 2, 2, '2025-05-11'),
(3, 1, 3, '2025-05-12'),
(4, 2, 4, '2025-05-12'),
...
ALTER TABLE `registrations`
  ...
  ADD CONSTRAINT `registrations_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`);
COMMIT;
